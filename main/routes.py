from flask import render_template, flash, redirect, url_for, request, abort, g, jsonify, current_app
...
from flaskTutorial.main import bp
from flaskTutorial.main.forms import EditProfileForm, PostForm, SearchForm, MessageForm
from flaskTutorial.models import User, Post, Message, Notification
from flaskTutorial.translate import translate
...
def search():
    ...
    next_url = url_for('main.search', q=g.search_form.q.data, page=page+1) \
                if total > current_app.config['POSTS_PER_PAGE'] else None
    prev_url = url_for('main.search', q=g.search_form.q.data, page=page+1) \
                if page > 1 else None
    return render_template('search.html', next_url=next_url, prev_url=prev_url,
                            posts=posts, title=_('Search'))
...
def notifications():
    ...
    try: 
        print(notifications[0].get_data())
    except:
        pass
    return jsonify([{
        'name': n.name,
